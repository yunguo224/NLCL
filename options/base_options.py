...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='DualExtractor_model', help='chooses which model to use.')
        ...
        parser.add_argument('--load_name', default=None, type=str, help='load name not the same with name')
